    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm font-semibold text-slate-600 mt-1">
          Sign in to access your ApnaTutorHub dashboard
        </p>
      </div>
      ...
      <button
        ...
        disabled={isLoading}
        className="neu-btn neu-btn-white w-full py-3 text-sm flex items-center justify-center gap-3 disabled:opacity-60 transition-all duration-200 cursor-pointer"
      >
        {isGoogleLoading ? (
          <>
