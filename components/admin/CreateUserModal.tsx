                ...
                <form onSubmit={handleSubmit} className="space-y-6 text-xs">
                  ...
                  {role === "TUTOR" && (
                    <div className="space-y-4 p-5 rounded-3xl bg-purple-50/40 border border-purple-200/80">
                      ...
                      {/* Standardized Hard-Pinned Subjects Taught */}
                      <div className="pt-1">
                        <SubjectPicker
                          value={tutorSubjects}
                          ...
                          hintText="Pick standard subjects from the platform taxonomy or search below."
                        />
                      </div>
                  ...
                  {role === "PARENT" && (
                    <div className="space-y-4 p-5 rounded-3xl bg-blue-50/40 border border-blue-200/80">
                      ...
                      {/* Standardized Hard-Pinned Parent Subjects */}
                      <div className="pt-1">
                        <SubjectPicker
                          value={parentSubjects}
                          onChange={setParentSubjects}
                          max={30}
                          title="Subjects Needed for Student;"
                          hintText="Pick standard subjects needed or search below."
                        />
                      </div>
