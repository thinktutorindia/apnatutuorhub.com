...
const MICRO_CLUSTERS: Record<string, Array<{ name: string; dist: number }>> = {
  // South Delhi / Sangam Vihar Cluster
  "sangam vihar": [
    { name: "Batra Hospital Area", dist: 1.2 },
    { name: "Sainik Farm (Gate No. 2)", dist: 2.1 },
    { name: "Khanpur Extension", dist: 1.8 },
    { name: "Devli Road", dist: 1.5 },
    { name: "Tigri Colony", dist: 1.9 },
    { name: "Hamdard Nagar", dist: 2.4 },
    { name: "Ambedkar Nagar Sector 4", dist: 2.8 },
    { name: "Madangir Phase 1", dist: 3.2 },
  ],
  ...
  "govindpuri": [
    ...
    { name: "CR Park (Chittaranjan Park)", dist: 2.5 },
    { name: "Alaknanda", dist: 2.8 },
    { name: "Tughlakabad Extension", dist: 1.9 },
    { name: "DDA Flats Kalkaji", dist: 1.6 },
    { name: "Okhla Phase 2 Industrial Area", dist: 2.6 },
  ],
  "batra": [
    { name: "Sangam Vihar Block L", dist: 1.1 },
    { name: "Tigri Gol Chakkar", dist: 1.4 },
    { name: "Devli Gaon", dist: 1.6 },
    { name: "Sainik Farm Western Avenue", dist: 2.0 },
    { name: "Khanpur Village", dist: 2.2 },
    { name: "Hamdard Convention Centre", dist: 2.5 },
  ],
  "sainik farm": [
    { name: "Neb Sarai", dist: 1.3 },
    { name: "Saket Metro Enclave", dist: 2.2 },
    { name: "Khanpur", dist: 2.0 },
    { name: "Sangam Vihar", dist: 2.4 },
    { name: "Freedom Fighters Enclave", dist: 2.5 },
  ],
  "saket": [
